...
## <p>Particles<p>
<p>Για τα particles, απλά ακολούθησα το tutorial της περιγραφής και έβαλα σε ένα random αντικείμενο στη πίστα μου το εφέ. Τα assets για τα particles τα βρήκα online. Γενικά, δεν ήταν κάτι περιέργο ή δύσκολο. Δυστυχώς ξέχασα να βγάλω πως φαίνονται τα particles μέσα στο παιχνίδι, αλλά θέλω να πιστεύω πως δεν πειράζει<p>
