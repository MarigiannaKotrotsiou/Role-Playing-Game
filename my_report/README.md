...
## <p>Particles<p>
<p>Για τα particles, απλά ακολούθησα το tutorial της περιγραφής και έβαλα σε ένα random αντικείμενο στη πίστα μου το εφέ. Τα assets για τα particles μου τα δάνεισε η συμφοιτήτρια μου, γιατί δεν έβρισκα κάτι καλύτερο, αλλά δυστυχώς δεν κράτησα τη πηγή. Γενικά, δεν ήταν κάτι περιέργο ή δύσκολο. Δυστυχώς ξέχασα να βγάλω πως φαίνονται τα particles μέσα στο παιχνίδι, αλλά θέλω να πιστεύω πως δεν πειράζει<p>
...
## <p>Menu<p>
<p>Για το μενού, έκανα νέο scene και ξεκίνησα να φτιάχνω το UI. Βάσει ενώς tutorial, έμαθα να φτιάχνω τα κουμπιά και το text. Έκανα κουμπί για Play, Introduction, Levels και Quit.<p>
